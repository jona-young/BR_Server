...
class courtInf(models.Model):
    ...
    sport = models.CharField(max_length=2, choices=[('TN', 'Tennis'), ('SQ', 'Squash')])
    ...
    #TODO: Look to add notes field...and STATUS SENT/UNSENT field?

    #Returns the infraction of a court infraction when it is called in the shell
    def __str__(self):
        return '{}({}) on {} at {}'.format(self.name, self.infraction, self.date, self.courtTime)
